    ...
    <section class="bg-gray-50 py-12">
        <div class="container mx-auto px-4">
            ...
            <div class="text-center mb-12">
                <h1 class="text-4xl lg:text-5xl font-bold text-primary mb-4">Apply to Speak at {{ $event->title }}</h1>
                ...
                <form method="POST" action="{{ URL::signedRoute('event.speakers.store', $event) }}"
                    ...
                    <div class="mb-12">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div class="md:col-span-2">
                                ...
                                <div class="mt-4 flex flex-col sm:flex-row items-center gap-6 p-6 bg-gray-50 rounded-xl border border-gray-200">
                                    <div class="flex-shrink-0">
                                        <div class="w-20 h-20 rounded-full bg-gray-200 flex items-center justify-center overflow-hidden border-2 border-gray-300">
                                    ...
                                    <div class="flex-grow">
                                        ...
                                        <p class="mt-2 text-sm text-gray-500">JPEG or PNG, max 2MB. Square images work best.</p>
                                        @error('photo')
                    ...
                    <div class="mb-12">
                        ...
                        <div class="mb-8">
                            ...
                            <p class="text-gray-500 text-sm mb-4">This will be displayed in the event program if you're selected.</p>
                    ...
                    <div class="mb-12">
                        ...
                        <!-- Topic Title -->
                        <div class="mb-8">
                            <label for="topic_title" class="block text-gray-700 font-medium mb-2">Proposed Topic Title</label>
                        ...
                        <!-- Topic Description -->
                        <div class="mb-8">
                            <label for="topic_description" class="block text-gray-700 font-medium mb-3 flex items-center">
                                <i data-lucide="align-left" class="w-5 h-5 mr-2 text-primary"></i>
                                Session Description
                            </label>
                            <p class="text-gray-500 text-sm mb-4">What will attendees learn from your session? Be specific and compelling.</p>
                        ...
                        <div class="mb-8">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mt-4">
                                @foreach (\App\Enums\SessionFormat::cases() as $format)
                                    <label class="flex items-center p-4 rounded-xl border border-gray-300 bg-white shadow-sm cursor-pointer hover:border-primary hover:shadow-md transition-all duration-200">
                        ...
                        <div>
                            ...
                            <p class="text-gray-500 text-sm mb-4">Special requirements, equipment needs, accessibility requests, or other information.</p>
                    ...
                    <div class="pt-8 border-t border-gray-200">
                        <div class="flex flex-col sm:flex-row justify-end gap-4">
                            ...
                            <button type="submit"
                                class="px-8 py-3 bg-secondary text-white rounded-lg hover:bg-secondary-600 focus:ring-4 focus:ring-secondary-200 transition-colors font-medium flex items-center justify-center">
