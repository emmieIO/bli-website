            ...
            @hasanyrole(['admin', 'super-admin'])
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    ...
                    <div class="bg-white rounded-xl shadow border border-gray-100 p-6">
                        ...
                        <p class="text-xs text-gray-500 mt-3">2 new courses this month</p>
                    </div>
                    ...
                    <div class="bg-white rounded-xl shadow border border-gray-100 p-6">
                        <div class="flex items-center justify-between">
                            <div>
                                ...
                                <h3 class="text-2xl font-bold text-gray-800 mt-1">158</h3>
                            </div>
                            <div class="p-3 rounded-full bg-green-50 text-green-600">
                        ...
                        <p class="text-xs text-gray-500 mt-3">+15 active this week</p>
                    </div>
                    ...
                    <div class="bg-white rounded-xl shadow border border-gray-100 p-6">
                        <div class="flex items-center justify-between">
                            <div>
                                <p class="text-sm font-medium text-gray-500">Assignments Graded</p>
                        ...
                        <p class="text-xs text-gray-500 mt-3">8 graded this week</p>
                    </div>
                    ...
                    <div class="bg-white rounded-xl shadow border border-gray-100 p-6">
                        ...
                        <p class="text-xs text-gray-500 mt-3">Next session: Friday 10am</p>
                    </div>
                    ...
                    <div class="bg-white rounded-xl shadow border border-gray-100 p-6">
                        <div class="flex items-center justify-between">
                            <div>
                                ...
                                <h3 class="text-2xl font-bold text-gray-800 mt-1">21</h3>
                            </div>
                            <div class="p-3 rounded-full bg-orange-50 text-orange-600">
                                <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none"
                                    viewBox="0 0 24 24" stroke="currentColor">
                        ...
                        <p class="text-xs text-gray-500 mt-3">5 new feedbacks this month</p>
                    </div>
                </div>
            @else
