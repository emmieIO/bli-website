<x-app-layout>
    ...
    <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <div>
            <h2 class="text-xl font-semibold text-[#00275E]">Instructor Management</h2>
        ...
        <div class="flex flex-col sm:flex-row gap-3 w-full sm:w-auto">
            <div class="relative w-full sm:w-64">
                <input type="text" placeholder="Search instructors..."
                    class="w-full pl-10 pr-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#ff0000] focus:border-[#ff0000] text-sm">
                <i data-lucide="search" class="absolute left-3 top-2.5 text-gray-400 w-5 h-5"></i>
            </div>
            <button type="button"
                class="inline-flex items-center px-4 py-2 bg-[#00275E] text-white text-sm font-medium rounded-lg hover:bg-[#001a44] transition shadow-sm">
    ...
    <x-instructor-dashbord-layout>
            ...
            <div id="massActionsBar" class="hidden bg-gray-50 px-6 py-3 border border-b border-gray-200 rounded-t-lg">
                <div class="flex items-center justify-between">
                    ...
                    <button id="massDeleteBtn"
                        class="text-[#ff0000] hover:text-[#cc0000] text-sm font-medium inline-flex items-center gap-2 disabled:opacity-50 disabled:cursor-not-allowed"
                        disabled>
                            ...
                            <tr>
                                <th scope="col"
                                    ...
                                    <input type="checkbox" id="selectAll"
                                        class="rounded border-gray-300 text-[#ff0000] focus:ring-[#ff0000]">
                                </th>
                                <th scope="col"
                                ...
                                <tr class="hover:bg-gray-50 transition-colors">
                                    ...
                                    <td class="px-6 py-4">
                                        <input type="checkbox" name="selected_instructors[]"
                                            value="{{ $instructor->id }}"
                                            class="rowCheckbox rounded border-gray-300 text-[#ff0000] focus:ring-[#ff0000]">
                                    </td>
                                    ...
                                    <td class="px-6 py-4">
                                        <div class="flex items-center gap-3">
                                            <div>
                                                <div class="font-medium text-gray-900">{{ $instructor->user->name }}
                                                </div>
                                    ...
                                    <td class="px-6 py-4">
                                        ...
                                        <div class="text-sm text-gray-500">{{ $instructor->user->phone ?? 'No phone' }}
                                        </div>
                                    </td>

                                    <!-- Headline -->
                                    <td class="px-6 py-4">
                                        <div class="text-sm text-gray-900 line-clamp-2">{{ $instructor->headline }}
                                        </div>
                                    </td>
                                    <!-- Headline -->
                                    <td class="px-6 py-4">
                                        <div class="text-sm text-gray-900 line-clamp-2">{{ sweet_date($instructor->deleted_at) }}
                                        </div>
                                    </td>
                                        ...
                                        <div class="inline-flex gap-2">
                                            @if ($instructor->trashed())
                                                <button type="button"
                                                    ...
                                                    class="p-1.5 text-green-600 hover:text-green-800 rounded-full hover:bg-green-100 transition-colors"
                                            ...
                                            @else
                                                <a href="{{ route('admin.instructors.edit', $instructor) }}"
                                                    title="Edit"
                                                    class="p-1.5 text-[#00275E] hover:text-[#001a44] rounded-full hover:bg-blue-100 transition-colors"
                                                    aria-label="Edit instructor">
                                                    <i data-lucide="edit" class="size-4"></i>
                                                </a>
                                                <a href="{{ route('admin.instructors.view', $instructor) }}" title="View"
                                                    class="p-1.5 text-[#ff0000] hover:text-[#cc0000] rounded-full hover:bg-red-100 transition-colors"
                                ...
                                <tr>
                                    <td colspan="6" class="px-6 py-12 text-center">
                                        <div class="flex flex-col items-center justify-center space-y-4 text-gray-400">
                                            ...
                                            <p class="max-w-md text-center">Add your first instructor to get started
                                            </p>
                                            <a href=""
                                                class="mt-2 inline-flex items-center px-4 py-2 bg-[#00275E] text-white text-sm font-medium rounded-lg hover:bg-[#001a44] transition shadow-sm">
            ...
            <div class="relative p-4 w-full max-w-md max-h-full">
                <div class="relative bg-white rounded-lg shadow">
                    <div class="flex items-center justify-between p-4 md:p-5 border-b rounded-t ">
                        <h3 class="text-lg font-semibold text-[#00275E]">
                    ...
                    <div class="p-4 md:p-5 space-y-4">
                        <div class="flex flex-col items-center text-center">
                            <div class="mx-auto flex-shrink-0 flex items-center justify-center h-12 w-12 rounded-full bg-red-100 mb-4">
                                <i data-lucide="alert-triangle" class="h-6 w-6 text-[#ff0000]"></i>
                            </div>
                            <h3 class="text-lg font-medium text-[#00275E] mb-2" id="instructor-delete-title">Remove Instructor</h3>
                            <div class="text-sm text-gray-500">
                                <p>Are you sure you want to remove <span id="instructor-name" class="font-semibold text-[#00275E]"></span>?</p>
                    ...
                    <div class="flex items-center justify-end p-4 md:p-5 border-t border-gray-200 rounded-b gap-3">
                        ...
                        <form method="POST" id="delete-instructor-form" class="inline">
                            ...
                            @method('DELETE')
                            <button type="submit"
                                class="text-white bg-[#ff0000] hover:bg-[#cc0000] focus:ring-4 focus:outline-none focus:ring-red-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center">
        ...
        <div id="restore-instructor" tabindex="-1" aria-hidden="true"
            ...
            <div class="relative bg-white rounded-lg shadow">
                ...
                <button type="button"
                    class="text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm w-8 h-8 ms-auto inline-flex justify-center items-center"
                    data-modal-hide="restore-instructor">
                    <i data-lucide="x" class="w-4 h-4"></i>
                    <span class="sr-only">Close modal</span>
                </button>
                </div>
                ...
                <div class="flex flex-col items-center text-center">
                    ...
                    <i data-lucide="rotate-ccw" class="h-6 w-6 text-green-600"></i>
                    </div>
                    <h3 class="text-lg font-medium text-[#00275E] mb-2" id="instructor-restore-title">Restore Instructor</h3>
                    <div class="text-sm text-gray-500">
                    <p>Are you sure you want to restore <span id="instructor-restore-name" class="font-semibold text-[#00275E]"></span>?</p>
        ...
        <script>
            document.addEventListener('DOMContentLoaded', function() {
                ...
                window.confirmInstructorRestore = function(button, instructorName){
                    ...
                    document.getElementById('instructor-restore-title').textContent = `Remove ${instructorName}`;
                }
            });
        </script>
    </x-instructor-dashbord-layout>
