            ...
            <form action="{{ route('admin.events.store') }}" method="POST" enctype="multipart/form-data"
                ...
                <div>
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
                        ...
                        <x-select id="" name="mode" label="Event Mode" :options="[
                            '' => 'Select event mode',
                            'online' => 'Online',
                            'offline' => 'Offline',
                            'hybrid' => 'Hybrid',
                ...
                <!-- Section: Media -->
                <div>
                    <h3 class="text-lg font-semibold text-gray-900 mb-4 pb-2 border-b border-gray-200">🖼️ Cover Image
                    </h3>
                    <div>
                ...
                <!-- Section: Options -->
                <div>
                    <h3 class="text-lg font-semibold text-gray-900 mb-4 pb-2 border-b border-gray-200">⚙️ Event Options
                    </h3>
                    <div class="flex flex-wrap items-center gap-6 p-4 bg-gray-50 rounded-lg">
                        ...
                        <label class="inline-flex items-center">
                            <input type="checkbox" name="is_allowing_application"
                                class="rounded border-gray-300 text-[#00275E] focus:ring-[#00275E]"
                                {{ old('is_allowing_application', true) ? 'checked' : '' }}>
