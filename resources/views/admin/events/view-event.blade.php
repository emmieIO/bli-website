                                    ...
                                    <div class="flex items-start gap-3">
                                        ...
                                        <div>
                                            ...
                                            <p class="text-sm text-gray-900">
                                                ...
                                                <span class="text-gray-500">{{ $event->physical_address ?? 'N/A' }}</span>
                                            </p>
                                        </div>
                                    </div>
                                @endif
                    ...
                    <div class="bg-white shadow rounded-lg overflow-hidden">
                        <div class="px-6 py-4 border-b border-gray-200 flex justify-between items-center">
                            ...
                            <a href="{{ route('admin.events.assign-speakers', $event) }}"
                                class="text-sm text-[#00275E] hover:text-teal-800 inline-flex items-center gap-1 font-medium">
                            ...
                            @if ($event->speakers->count())
                                @foreach ($event->speakers as $speaker)
                                    <div class="p-6 flex items-start gap-4">
                                        <div class="h-20 w-20 rounded-full border-2 border-gray-200 overflow-hidden flex-shrink-0">
                                ...
                                @foreach ($event->recentRegistrations() as $recent)
                                    <div class="p-4 flex items-center gap-3">
                                        ...
                                        <div class="min-w-0 flex-1">
                                            <p class="text-sm font-medium text-gray-900 truncate">{{ $recent->name }}</p>
