    ...
    <div class="">
        ...
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-8">
            <div class="flex items-center gap-3">
                <div>
                    <h1 class="text-2xl font-extrabold ">Update Event</h1>
        ...
        <div class="bg-white border border-gray-100 rounded-xl shadow-sm p-6 md:p-8">
            <form action="{{ route('admin.events.update', $event) }}" method="POST" enctype="multipart/form-data"
                ...
                <div class="pt-6 border-t border-gray-200 flex flex-col sm:flex-row justify-end gap-3">
                    ...
                    <button type="submit"
                        class="px-6 py-2.5 inline-flex items-center text-sm font-medium text-white bg-orange-600 rounded-lg hover:bg-[#FF0000] focus:ring-4 focus:ring-blue-300 focus:outline-none transition">
