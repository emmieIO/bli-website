            ...
            <nav className="bg-white shadow-lg sticky top-0 z-50 border-b border-gray-100">
                <div className="max-w-7xl mx-auto flex justify-between items-center py-3 px-4 md:px-8">
                    ...
                    <ul className="hidden lg:flex gap-x-8 items-center font-semibold text-sm">
                        ...
                        <li className="relative" onMouseEnter={() => setJoinUsDropdownOpen(true)} onMouseLeave={() => setJoinUsDropdownOpen(false)}>
                            <a href="#" className="flex items-center gap-2 py-2 px-1 transition-all duration-300 group relative dropdown-trigger" style={{ color: '#002147' }}>
