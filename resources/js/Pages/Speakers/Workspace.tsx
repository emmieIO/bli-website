...
const stageTone: Record<Props['stage'], string> = {
  invited: 'bg-primary-50 text-primary',
        ...
        <section className="grid gap-6 lg:grid-cols-[minmax(0,1.35fr)_minmax(320px,0.85fr)]">
          <div className="space-y-6">
            ...
            <div className="rounded-lg border border-slate-200 bg-white p-6 shadow-sm">
              ...
              <div className="mt-5 rounded-lg border border-dashed border-slate-300 bg-slate-50 p-4 text-sm leading-6 text-slate-500">
...
function WorkspaceRow({ label, value }: { label: string; value: string }) {
  return (
    <div className="grid gap-2 border-b border-slate-200 pb-4 last:border-b-0 last:pb-0 sm:grid-cols-[140px_minmax(0,1fr)]">
