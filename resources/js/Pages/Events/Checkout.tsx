            ...
            <div className="min-h-screen bg-gray-50 py-12 px-4 sm:px-6 lg:px-8">
                <div className="max-w-4xl mx-auto">
                    ...
                    <div className="text-center mb-8">
                        <h1 className="text-3xl font-bold text-gray-900 font-montserrat">Complete Your Registration</h1>
                        <p className="mt-2 text-gray-600 font-lato">Secure your spot for this event</p>
                    </div>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                            ...
                            <div className="bg-white rounded-lg shadow-md p-6 mb-6">
                                ...
                                <div className="flex gap-4">
                                    ...
                                    <div className="flex-1">
                                        <h3 className="font-semibold text-gray-900 font-montserrat">{event.title}</h3>
                                    ...
                                    <div className="text-right">
                                        <p className="text-2xl font-bold text-primary font-montserrat">
                                            ₦{Number(event.entry_fee).toLocaleString()}
                                        </p>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div className="lg:col-span-1">
                            <div className="bg-white rounded-lg shadow-md p-6 sticky top-4">
                                <h3 className="text-lg font-bold text-gray-900 mb-4 font-montserrat">Registration Benefits</h3>
                                ...
                                <div className="mt-6 pt-6 border-t border-gray-200">
                                    <button
                                        onClick={() => router.visit(route('events.show', event.slug))}
