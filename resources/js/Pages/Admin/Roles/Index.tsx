    ...
    <DashboardLayout sideLinks={sideLinks}>
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-8">
        ...
        <div className="flex items-center gap-3">
          <Link
            ...
            className="inline-flex items-center gap-2 bg-gray-600 hover:bg-gray-700 py-3 px-6 rounded-lg font-medium text-white transition-all duration-200 shadow-sm"
          >
      ...
      <div className="bg-white rounded-lg border border-slate-200 shadow-lg">
        <div className="p-6 border-b border-slate-200">
          ...
          <p className="text-slate-500 mt-1">Manage detailed permissions for each role</p>
        </div>
                ...
                <table className="w-full text-sm">
                  <thead>
                    <tr className="border-b border-slate-200">
                      <th className="text-left py-3 px-4 font-medium text-slate-500 w-1/3">
                        Permission
                      </th>
                      {roles.map((role) => (
                        <th
                          key={role.id}
                          className="text-center py-3 px-4 font-medium text-slate-500"
                        >
      ...
      <div className="mt-8 bg-slate-50 rounded-lg p-6 border border-slate-200">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          ...
          <button
            ...
            className="flex items-center justify-center gap-2 px-4 py-3 bg-purple-500 hover:bg-purple-600 text-white rounded-lg transition-colors"
          >
...
function RoleCard({ role }: { role: Role }) {
  ...
  return (
    <div className={`bg-white rounded-lg border border-slate-200 shadow-sm ${colors.bg}`}>
      <div className="p-6">
        ...
        <div className="space-y-2">
          ...
          <div className="flex flex-wrap gap-1">
            {role.permissions.slice(0, 4).map((permission) => (
              <span
                key={permission.id}
                className="inline-flex items-center px-2 py-1 rounded text-xs font-medium bg-white text-slate-500"
              >
