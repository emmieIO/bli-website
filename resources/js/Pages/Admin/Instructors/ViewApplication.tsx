      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-8 gap-4">
          <div>
            ...
            <p className="text-slate-500">Submitted on {submittedDate}</p>
          </div>
        ...
        <div className="bg-white rounded-lg border border-slate-200 overflow-hidden mb-8 border border-slate-200">
          <div className="bg-white p-4 rounded-lg shadow-sm border border-slate-200 w-full md:w-auto">
            <div className="flex items-center space-x-4">
              <div className="bg-[#e6f7ff] p-3 rounded-full">
                <i className="fas fa-user w-6 h-6 text-[#002147]"></i>
              </div>
              <div>
                <h3 className="font-medium text-slate-900">{application.user.name}</h3>
        ...
        <div className="border-b border-slate-200 px-6 py-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            <div>
              <p className="text-sm text-slate-500 font-medium">Profile ID</p>
              <p className="font-medium text-slate-700">{application.application_id}</p>
            </div>
            <div>
              <p className="text-sm text-slate-500 font-medium">Professional Headline</p>
              <p className="font-medium text-slate-700">{application.user.headline}</p>
            </div>
            <div>
              ...
              <div className="flex items-center">
                ...
                <span className="font-medium text-slate-700">{application.experience_years}</span>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="border-b border-slate-200 px-6 py-4">
          ...
          <p className="whitespace-pre-line text-slate-700 leading-relaxed">{application.bio}</p>
        </div>
        ...
        <div className="border-b border-slate-200 px-6 py-4">
          ...
          <p className="whitespace-pre-line text-slate-700 leading-relaxed">{application.teaching_history}</p>
        </div>
        ...
        <div className="px-6 py-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            {application.resume_path && (
              <div className="border border-slate-200 rounded-lg p-4 hover:border-[#002147] transition">
                <div className="flex items-start">
                  <div className="p-2 bg-[#e6f7ff] rounded-lg mr-4">
                    <i className="fas fa-file-pdf w-6 h-6 text-[#002147]"></i>
                  </div>
                  <div>
                    <h3 className="font-medium text-slate-700">Professional Resume</h3>
                    <p className="text-sm text-slate-500 mb-2">PDF document</p>
                    <a
            ...
            {application.intro_video_url && (
              <div className="border border-slate-200 rounded-lg p-4 hover:border-[#002147] transition">
                <div className="flex items-start">
                  ...
                  <div>
                    <h3 className="font-medium text-slate-700">Introduction Video</h3>
                    <p className="text-sm text-slate-500 mb-2">YouTube link</p>
                    <a
        ...
        <div className="flex flex-col sm:flex-row justify-end gap-4 mt-8">
          ...
          {!application.is_approved && (
            <button
              ...
              className="px-6 py-3 bg-primary text-white rounded-lg hover:bg-[#001a44] transition flex items-center justify-center"
            >
          ...
          <div className="bg-white rounded-lg border border-slate-200 w-full max-w-md">
            <div className="p-6">
              <div className="flex justify-between items-center mb-4">
                <h3 className="text-xl font-semibold text-slate-900">Reject Application</h3>
                <button
              ...
              <form onSubmit={handleReject}>
                <div className="mb-6">
                  <label htmlFor="rejection_reason" className="block text-sm font-medium text-slate-700 mb-2">
      ...
      {showApproveModal && (
        <div className="fixed inset-0 bg-gray-600/40 bg-opacity-50 flex items-center justify-center z-50 px-4">
          <div className="bg-white rounded-lg border border-slate-200 w-full max-w-md">
            <div className="p-6">
              <div className="flex justify-between items-center mb-4">
                <h3 className="text-xl font-semibold text-slate-900">Approve Application</h3>
                <button
              ...
              <div className="flex justify-center gap-3">
                <button
                  ...
                  disabled={isSubmitting}
                  className="text-white bg-primary hover:bg-[#001a44] focus:ring-4 focus:outline-none focus:ring-[#002147] font-medium rounded-lg text-sm px-5 py-2.5 disabled:opacity-50 disabled:cursor-not-allowed"
                >
