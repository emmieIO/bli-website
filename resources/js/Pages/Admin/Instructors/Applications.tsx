...
export default function Applications({ instructorProfiles }: Props) {
  ...
  const getStatusBadge = (status: string) => {
    ...
    return (
      <span className={`px-2 py-1 text-xs font-medium rounded-full ${statusColors[status] || 'bg-slate-100 text-slate-700'}`}>
    ...
    <DashboardLayout>
        ...
        <div className="mb-6 border-b border-slate-200">
          <nav className="-mb-px flex space-x-8">
            <Link
              ...
              className="border-b-2 border-transparent text-slate-500 hover:text-slate-700 hover:border-slate-300 whitespace-nowrap py-4 px-1 font-medium text-sm transition-colors"
            >
              Active Instructors
            </Link>
            <Link
        ...
        <div className="mb-4">
          <div className="relative">
            ...
            <input
              ...
              className="block w-full pl-10 pr-3 py-2 border border-slate-300 rounded-lg focus:ring-primary focus:border-primary"
      ...
      {showApproveModal && selectedProfile && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
          <div className="bg-white rounded-lg border border-slate-200 max-w-md w-full mx-4">
            <div className="p-6">
              <div className="flex items-center justify-center w-12 h-12 mx-auto mb-4 bg-green-100 rounded-full">
                <i className="fas fa-check text-green-600 text-xl"></i>
              </div>
              <h3 className="mb-2 text-lg font-medium text-slate-900 text-center">
                Approve Application
              </h3>
              ...
              <div className="flex items-center justify-center gap-3">
                ...
                <button
                  ...
                  disabled={isApproving}
                  className="px-5 py-2.5 bg-white text-slate-900 border border-slate-300 rounded-lg hover:bg-slate-100 text-sm font-medium"
                >
                  No, cancel
                </button>
              </div>
