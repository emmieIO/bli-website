          ...
          <div className="bg-primary-50 px-6 py-3 border-b border-primary-200 rounded-t-lg">
            <div className="flex items-center justify-between">
              ...
              <button
                ...
                className="text-red-600 hover:text-red-700 text-sm font-medium inline-flex items-center gap-2 transition-colors"
              >
            ...
            <table className="min-w-full divide-y divide-gray-200 text-sm">
              <thead className="bg-slate-50">
                <tr>
                  <th
                    scope="col"
                    className="px-6 py-3 text-left text-xs font-semibold text-slate-700 uppercase tracking-wider w-4"
                  >
                    <input
                      type="checkbox"
                      checked={
        ...
        >
          ...
          <div className="flex justify-end gap-3">
            ...
            <button
              ...
              className="px-5 py-2.5 text-sm font-medium text-white bg-red-600 hover:bg-red-700 rounded-lg transition-colors inline-flex items-center disabled:opacity-50"
            >
              {isProcessing ? (
                <>
        ...
        >
          ...
          <div className="flex justify-end gap-3">
            ...
            <button
              ...
              disabled={isProcessing}
              className="px-5 py-2.5 text-sm font-medium text-white bg-primary hover:bg-primary-600 rounded-lg transition-colors inline-flex items-center disabled:opacity-50"
            >
              {isProcessing ? (
                <>
                  <i className="fas fa-spinner fa-spin w-4 h-4 mr-2"></i>
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/30 backdrop-blur-sm">
      <div className="relative bg-white rounded-lg border border-slate-200 p-6 w-full max-w-md mx-4 border border-slate-200">
        <button
          type="button"
          onClick={onClose}
          className="absolute top-3 right-3 text-gray-400 hover:bg-slate-200 hover:text-slate-900 rounded-lg text-sm w-8 h-8 inline-flex justify-center items-center"
        >
