  ...
  return (
    <DashboardLayout sideLinks={sideLinks}>
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-6">
        <div>
          <h2 className="text-xl font-semibold text-slate-700">Application Logs</h2>
      ...
      {showDeleteModal && logToDelete && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/30 backdrop-blur-sm">
          <div className="relative bg-white rounded-lg border border-slate-200 p-4 w-full max-w-md mx-4 border border-slate-200">
            <button
              type="button"
              onClick={() => setShowDeleteModal(false)}
              className="absolute top-3 right-3 text-gray-400 bg-transparent hover:bg-slate-100 hover:text-slate-500 rounded-lg text-sm w-8 h-8 inline-flex justify-center items-center transition-colors"
            >
            ...
            <div className="p-4 text-center">
              ...
              <h3 className="mb-5 text-lg font-normal text-slate-500">
              ...
              <form onSubmit={handleDelete}>
                <div className="flex items-center justify-center">
                  ...
                  <button
                    type="button"
                    onClick={() => setShowDeleteModal(false)}
                    className="py-2.5 px-5 ml-3 text-sm font-medium text-slate-900 focus:outline-none bg-white rounded-lg border border-slate-200 hover:bg-slate-100 hover:text-blue-700 focus:z-10 focus:ring-4 focus:ring-gray-100"
                  >
                    No, cancel
                  </button>
                </div>
