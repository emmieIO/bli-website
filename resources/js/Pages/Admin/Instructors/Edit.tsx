      ...
      <div className="max-w-4xl mx-auto p-6">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-8">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-2xl md:text-3xl font-extrabold text-slate-900">Edit Instructor Profile</h1>
              <p className="text-sm text-slate-500 mt-1">Update instructor details and manage their profile information</p>
            </div>
          </div>
          ...
          <Link
            ...
            className="inline-flex items-center px-4 py-2 border border-slate-300 rounded-lg text-sm font-medium text-slate-700 bg-white hover:bg-slate-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#002147] transition"
          >
        ...
        {/* Form Card */}
        <div className="bg-white rounded-lg border border-slate-200 border border-slate-200 p-6 md:p-8">
          <form onSubmit={handleSubmit} className="space-y-8">
            ...
            <div>
              ...
              <Textarea
                ...
                required
              />
              <p className="mt-1 text-xs text-slate-500">Max 500 characters recommended.</p>
            </div>
            ...
            <div>
              ...
              <div className="grid md:grid-cols-2 gap-6">
                <div>
                  <label htmlFor="resume_path" className="block mb-2 text-sm font-medium text-slate-900">
                    Resume (PDF, DOCX)
                  </label>
                  <input
                    type="file"
                    ...
                    className="block w-full text-sm text-slate-900 bg-slate-50 rounded-lg border border-slate-300 focus:ring-2 focus:ring-[#002147] focus:border-[#002147]
                      ...
                      file:bg-primary file:text-white hover:file:bg-[#001a44] transition"
                  />
                  ...
                  {errors?.resume_path && (
                    <p className="text-sm text-red-500 mt-1">{errors.resume_path}</p>
                  )}
                </div>

                <div>
                  <label htmlFor="application_status" className="block mb-2 text-sm font-medium text-slate-900">
                    Application Status
                  </label>
                  <select
                    ...
                    onChange={handleInputChange}
                    className="block w-full p-3 text-sm text-slate-900 bg-slate-50 rounded-lg border border-slate-300 focus:ring-2 focus:ring-[#002147] focus:border-[#002147] transition"
                  >
                  ...
                  {errors?.application_status && (
                    <p className="text-sm text-red-500 mt-1">{errors.application_status}</p>
                  )}
                  <p className="mt-1 text-xs text-slate-500">Changing status may trigger notifications.</p>
                </div>
              </div>
            </div>
            ...
            <div className="pt-6 border-t border-slate-200 flex flex-col sm:flex-row justify-end gap-3">
              ...
              <button
                ...
                className="px-6 py-2.5 text-sm font-medium text-white bg-primary rounded-lg hover:bg-[#001a44] focus:ring-4 focus:ring-blue-300 focus:outline-none transition flex items-center justify-center disabled:opacity-50 disabled:cursor-not-allowed"
              >
