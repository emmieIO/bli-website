      ...
      <div className="py-8 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-8">
          <div className="flex items-center gap-4">
            <Link
              ...
              className="inline-flex items-center justify-center w-10 h-10 bg-white border border-slate-300 rounded-full text-slate-700 hover:bg-slate-50 hover:text-[#002147] focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#002147] transition shadow-sm"
            ...
            <div>
              ...
              <p className="text-sm text-slate-500">Speaker Profile Details</p>
            </div>
          </div>
          ...
          <div className="flex items-center gap-3">
            <Link
              ...
              className="inline-flex items-center px-4 py-2.5 bg-white border border-slate-300 rounded-lg shadow-sm text-sm font-medium text-[#002147] hover:bg-slate-50 hover:text-[#FF0000] focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#002147] transition"
            >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div className="bg-white border border-slate-200 rounded-lg shadow-sm overflow-hidden">
              <div className="p-6 flex flex-col sm:flex-row items-start sm:items-center gap-6">
                ...
                <div className="flex-1 min-w-0">
                  <h2 className="text-xl font-bold text-slate-900">{speaker.user.name}</h2>
                ...
                {speaker.user.phone && (
                  <div className="flex items-center gap-3 p-3 bg-slate-50 rounded-lg hover:bg-slate-100 transition">
                    ...
                    <div>
                      ...
                      <div className="font-medium text-slate-900">{speaker.user.phone}</div>
                    </div>
                  </div>
                )}
                ...
                {speaker.user.website && (
                  <div className="flex items-center gap-3 p-3 bg-slate-50 rounded-lg hover:bg-slate-100 transition">
                    <div className="p-2 bg-slate-100 rounded-lg">
                      <i className="fas fa-globe w-4 h-4 text-slate-500"></i>
                    </div>
                    <div>
                      ...
                      <a
                        ...
                        target="_blank"
                        rel="noopener noreferrer"
                        className="font-medium text-slate-900 hover:underline hover:text-[#002147] truncate block max-w-[200px]"
                      >
          ...
          <div className="space-y-6">
            {/* Status & Metadata */}
            <div className="bg-white border border-slate-200 rounded-lg shadow-sm p-6">
              <h3 className="text-lg font-semibold text-slate-900 mb-4">Profile Status</h3>
              <div className="space-y-4">
                ...
                <div className="flex justify-between items-center">
                  ...
                  <span className="text-sm font-medium text-slate-900">{updatedDate}</span>
                </div>
                {speaker.is_featured && (
                  <div className="flex justify-between items-center">
            ...
            <div className="bg-white border border-slate-200 rounded-lg shadow-sm p-6">
              ...
              <p className="text-sm text-slate-500 mb-4">This space can be used for:</p>
            ...
            <div className="bg-white border border-slate-200 rounded-lg shadow-sm p-6">
              ...
              <div className="space-y-3">
                <Link
                  href={route('admin.speakers.edit', speaker.id)}
                  className="flex items-center gap-3 w-full p-3 text-sm text-[#002147] bg-slate-50 rounded-lg hover:bg-slate-100 hover:text-[#FF0000] transition"
                >
                ...
                <Link
                  href={route('admin.speakers.index')}
                  className="flex items-center gap-3 w-full p-3 text-sm text-slate-700 bg-slate-50 rounded-lg hover:bg-slate-100 transition"
                >
          ...
          <div className="bg-white rounded-lg border border-slate-200 w-full max-w-md">
            <div className="p-6">
              <div className="flex justify-between items-center mb-4">
                <h3 className="text-xl font-semibold text-slate-900">Delete Speaker</h3>
                <button
