        ...
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-8">
          <div className="flex items-center gap-3">
            <Link
              ...
              className="inline-flex items-center justify-center overflow-hidden w-10 h-10 bg-white border rounded-full border-slate-300 text-slate-700 text-sm font-medium hover:bg-slate-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#002147] transition shadow-sm"
            ...
            <div>
              ...
              <p className="text-sm text-slate-500">Review speaker session proposal details</p>
            </div>
          </div>
        </div>

        <div className="bg-white rounded-lg border border-slate-200 border border-slate-200 overflow-hidden">
          {/* Application Header */}
              ...
              <div className="border border-slate-200 rounded-lg p-6 bg-slate-50">
                ...
                <div className="space-y-5">
                  ...
                  <div>
                    ...
                    <div className="prose prose-sm max-w-none text-slate-700 bg-white p-3 rounded-lg border">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                      <label className="block text-sm font-medium text-slate-700 mb-1">Session Format</label>
                  ...
                  {application.event && (
                    <div className="border-t border-slate-200 pt-4">
                      <label className="block text-sm font-medium text-slate-700 mb-1">Event Information</label>
                ...
                <div className="flex flex-col sm:flex-row gap-6">
                  <div className="shrink-0">
                    {speakerPhoto ? (
                      ...
                      <div className="h-20 w-20 rounded-full bg-slate-200 flex items-center justify-center border-2 border-dashed border-slate-300">
                  ...
                  <div className="grow">
                    ...
                    <p className="text-[#002147] font-medium mb-4">
                      ...
                      {application.speaker?.organization && (
                        <> at <span className="text-slate-700">{application.speaker.organization}</span></>
                      )}
                    </p>

                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                      <div className="flex items-center text-sm text-slate-500 p-2 bg-white rounded-lg border">
                    ...
                    <div className="flex flex-wrap gap-2">
                      {application.speaker?.linkedin && (
                        <a
                          ...
                          className="inline-flex items-center px-3 py-1.5 border border-slate-300 text-xs font-medium rounded-lg text-slate-700 bg-white hover:bg-slate-50 hover:text-[#002147] transition"
                        >
                  ...
                  {application.status === 'pending' && (
                    <>
                      ...
                      <button
                        ...
                        className="w-full inline-flex items-center justify-center px-4 py-2.5 border border-transparent text-sm font-medium rounded-lg shadow-sm text-white bg-primary hover:bg-primary-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#002147] transition"
                      >
                ...
                <div className="space-y-3 text-sm">
                  ...
                  {application.updated_at && application.updated_at !== application.created_at && (
                    <div className="flex justify-between">
                      ...
                      <span className="font-medium text-slate-900">{formatDate(application.updated_at)}</span>
                    </div>
                  )}
                </div>
              </div>
          ...
          <div className="bg-white rounded-lg border border-slate-200 w-full max-w-md">
            <div className="p-6">
              <div className="flex justify-between items-center mb-4">
                <h3 className="text-xl font-semibold text-slate-900">Approve Speaker Application</h3>
                <button
                  onClick={() => setShowApproveModal(false)}
                  className="text-gray-400 cursor-pointer hover:text-slate-500"
                >
              ...
              <div className="flex justify-center gap-3">
                <button
                  ...
                  className="text-white bg-primary hover:bg-primary-600 focus:ring-4 focus:outline-none focus:ring-[#002147] font-medium rounded-lg text-sm px-5 py-2.5 disabled:opacity-50 disabled:cursor-not-allowed"
                >
                  {isSubmitting ? 'Approving...' : 'Approve'}
                </button>
                <button
                  onClick={() => setShowApproveModal(false)}
                  className="py-2.5 px-5 text-sm font-medium text-slate-900 bg-white rounded-lg border border-slate-200 hover:bg-slate-100"
                >
                  Cancel
                </button>
              </div>
              ...
              <form onSubmit={application.status === 'approved' ? handleRevoke : handleReject}>
                <div className="mb-6">
                  ...
                  <textarea
                    ...
                    className="w-full px-3 py-2 border border-slate-300 rounded-lg focus:ring-[#002147] focus:border-[#002147]"
