      ...
      <div className="workspace-stack">
        <section className="workspace-header-card px-6 py-6 lg:px-8">
          <div className="max-w-3xl">
            <p className="workspace-muted-label">Support Operations</p>
            <h1 className="mt-3 text-3xl font-semibold tracking-tight text-slate-900">Support Tickets</h1>
            <p className="mt-3 text-sm leading-7 text-slate-600">
              Review incoming user issues, prioritize follow-up, and keep the support queue under control.
            </p>
          </div>
        </section>
