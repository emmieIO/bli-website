        ...
        <div className="max-w-4xl mx-auto sm:px-6 lg:px-8">
          <div className="mb-8">
            ...
            <div className="flex justify-between items-start mt-4">
              <div>
                <h1 className="text-3xl font-bold text-slate-900">Mentorship Request</h1>
                <p className="mt-2 text-sm text-slate-500">Request ID: #{mentorshipRequest.id}</p>
              </div>
          ...
          <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="bg-white shadow rounded-lg p-6">
                ...
                <div>
                  <p className="text-slate-900 font-medium">{mentorshipRequest.student.name}</p>
                  <p className="text-sm text-slate-500">{mentorshipRequest.student.email}</p>
                </div>
              </div>
              <div className="bg-white shadow rounded-lg p-6">
                <h2 className="text-lg font-semibold mb-4">Instructor</h2>
                <div>
                  <p className="text-slate-900 font-medium">{mentorshipRequest.instructor.name}</p>
                  <p className="text-sm text-slate-500">{mentorshipRequest.instructor.email}</p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white shadow rounded-lg p-6">
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <p className="mt-1 text-slate-900">{mentorshipRequest.formatted_duration}</p>
                </div>
                <div>
                  <label className="block text-sm font-medium text-slate-700">Student's Message</label>
                  <p className="mt-1 text-slate-900 whitespace-pre-wrap">{mentorshipRequest.message}</p>
                </div>
                {mentorshipRequest.goals && (
                  <div>
                    <label className="block text-sm font-medium text-slate-700">Learning Goals</label>
                    <p className="mt-1 text-slate-900 whitespace-pre-wrap">{mentorshipRequest.goals}</p>
                  </div>
                )}
              </div>
            </div>
