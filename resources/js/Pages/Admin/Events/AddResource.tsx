              ...
              <div className="relative">
                ...
                <select
                  ...
                  className={`block w-full pl-10 pr-10 py-3 border rounded-lg shadow-sm focus:ring-2 focus:outline-none text-sm bg-slate-50 focus:bg-white transition-all ${
                    errors?.type ? 'border-red-500 focus:ring-red-500' : 'border-slate-300 focus:ring-primary focus:border-primary'
                  }`}
              ...
              {formData.type === 'link' ? (
                <div className="space-y-3">
                  <div className="flex items-center gap-2 mb-4">
                    ...
                    <div>
                      <h3 className="text-sm font-semibold text-slate-900">External Link</h3>
                      <p className="text-xs text-slate-500">Provide a URL to an external resource</p>
                    </div>
                  </div>
                  <Input
                    label="Resource URL"
                ...
                <div className="space-y-3">
                  <div className="flex items-center gap-2 mb-4">
                    ...
                    <div>
                      <h3 className="text-sm font-semibold text-slate-900">File Upload</h3>
                      <p className="text-xs text-slate-500">Upload a file from your computer</p>
                    </div>
                  </div>
                  <div>
                    <label htmlFor="file_path" className="block text-sm font-medium text-slate-700 mb-2">
                      ...
                      <input
                        ...
                        className={`block w-full text-sm text-slate-900 bg-white rounded-lg border-2 border-dashed focus:ring-2 focus:outline-none p-4
                          ...
                          file:text-white hover:file:opacity-90 file:transition cursor-pointer hover:border-primary transition-all ${
                            errors?.file_path ? 'border-red-500 focus:ring-red-500' : 'border-slate-300 focus:ring-primary'
                          }`}
                    ...
                    {errors?.file_path && (
                      <p className="text-sm text-red-500 mt-2">{errors.file_path}</p>
                    )}
