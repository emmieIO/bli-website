...
export default function Show({ mentorshipRequest, sessions, resources, milestones }: Props) {
    ...
    const getStatusBadge = (status: string) => {
        const badges: Record<string, { bg: string; text: string; label: string }> = {
            ...
            instructor_rejected: { bg: 'bg-red-100', text: 'text-red-800', label: 'Instructor Rejected' },
                ...
                <div className="max-w-7xl mx-auto sm:px-6 lg:px-8">
                    ...
                    <div className="mb-8">
                        ...
                        <div className="flex justify-between items-center mt-4">
                            <div>
                                <h1 className="text-3xl font-bold text-gray-900">Mentorship with {mentorshipRequest.instructor.name}</h1>
                                        ...
                                        <div className="space-y-4">
                                            ...
                                            <div className="flex items-start">
                                                <div className={`flex-shrink-0 h-10 w-10 rounded-full flex items-center justify-center ${
                                                    mentorshipRequest.instructor_approved_at ? 'bg-green-100' : 'bg-yellow-100'
                                                }`}>
                                                ...
                                                <div className="ml-4 flex-1">
                                                    <h4 className="text-sm font-medium text-gray-900">Instructor Review</h4>
                        ...
                        <form onSubmit={handleSessionSubmit}>
                            <div className="mb-4">
                                ...
                                {sessionForm.errors.session_date && (
                                    <p className="mt-1 text-sm text-red-600">{sessionForm.errors.session_date}</p>
                                )}
                            </div>
                            <div className="mb-4">
                                <label className="block text-sm font-medium text-gray-700 mb-2">
                        ...
                        <form onSubmit={handleMilestoneSubmit}>
                            <div className="mb-4">
                                ...
                                {milestoneForm.errors.title && (
                                    <p className="mt-1 text-sm text-red-600">{milestoneForm.errors.title}</p>
                                )}
                            </div>
                            <div className="mb-4">
                                <label className="block text-sm font-medium text-gray-700 mb-2">
