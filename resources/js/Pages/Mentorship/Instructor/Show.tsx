...
export default function Show({ mentorshipRequest, sessions, resources, milestones }: Props) {
  ...
  const getStatusBadge = (status: string) => {
    const badges: Record<string, { bg: string; text: string; label: string }> = {
      ...
      instructor_rejected: { bg: 'bg-accent-50', text: 'text-accent', label: 'You Rejected' },
        ...
        <div className="max-w-7xl mx-auto sm:px-6 lg:px-8">
          ...
          <div className="mb-8">
            ...
            <div className="flex justify-between items-center mt-4">
              <div>
                <h1 className="text-3xl font-bold text-slate-900">Mentorship with {mentorshipRequest.student.name}</h1>
                ...
                <div className="space-y-6">
                  ...
                  <div>
                    ...
                    <div className="bg-slate-50 rounded-lg p-4 space-y-3">
                      <div>
                        <label className="block text-sm font-medium text-slate-700">Student's Message</label>
                        <p className="mt-1 text-sm text-slate-900">{mentorshipRequest.message}</p>
                      </div>
                      {mentorshipRequest.goals && (
                        <div>
                          <label className="block text-sm font-medium text-slate-700">Student's Goals</label>
                      ...
                      <div className="space-y-4">
                        ...
                        <div className="flex items-start">
                          <div className={`flex-shrink-0 h-10 w-10 rounded-full flex items-center justify-center ${
                            mentorshipRequest.instructor_approved_at ? 'bg-lime-100' : 'bg-accent-50'
                          }`}>
                          ...
                          <div className="ml-4 flex-1">
                            <h4 className="text-sm font-medium text-slate-900">Your Review</h4>
            ...
            <form onSubmit={handleReject}>
              <div className="mb-4">
                ...
                {rejectForm.errors.reason && (
                  <p className="mt-1 text-sm text-accent">{rejectForm.errors.reason}</p>
                )}
              </div>
              <div className="flex justify-end space-x-3">
                <button
