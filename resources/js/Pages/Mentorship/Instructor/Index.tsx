...
export default function Index({ requests, pending, statistics, expiringWarnings }: Props) {
  ...
  return (
    <DashboardLayout sideLinks={sideLinks}>
      <Head title="Mentorship Requests" />
              ...
              {expiringWarnings.map((warning) => (
                ...
                >
                  <div className="flex items-start justify-between">
                    <div className="flex items-start space-x-3">
                      ...
                      <div>
                        ...
                        <p className="text-sm mt-1">
                          Your mentorship with <strong>{warning.student}</strong> {warning.expiration_status.message.toLowerCase()}
                        </p>
                    ...
                    <Link
                      href={route('instructor.mentorship.show', warning.id)}
          ...
          <div className="bg-white border border-slate-200 rounded-lg overflow-hidden">
            {requests.length === 0 ? (
              <div className="text-center py-12">
                ...
                <p className="mt-1 text-sm text-slate-500">Mentorship requests from students will appear here.</p>
              </div>
            ) : (
                  ...
                  {requests.map((request) => (
                    <tr key={request.id} className="hover:bg-slate-50">
                      ...
                      <td className="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                        <Link
                          href={route('instructor.mentorship.show', request.id)}
