...
class CreateEventRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'location' => 'nullable|url:http,https|max:2048|required_if:mode,online,hybrid',
    ...
    public function messages()
    {
        return [
            ...
            'location.required' => 'The default meeting link is required.',
            'location.required_if' => 'A default meeting link is required for online or hybrid events.',
            'location.url' => 'The default meeting link must be a valid http or https URL.',
    ...
    protected function prepareForValidation(): void
    {
        ...
        $this->merge([
            ...$this->normalizedEventFields(useAuthenticatedCreator: true),
            'status' => $status,
            'is_active' => $isActive,
            'is_published' => $isPublished,
            'is_allowing_application' => $this->boolean('is_allowing_application'),
            'is_featured' => $this->boolean('is_featured'),
            'require_sign_up' => $this->boolean('require_sign_up', true),
        ]);
    }
}
